...
function openPopUp(dataType, element) {
    ...
    switch (dataType) {
        ...
        case "m3u":
            ...
            var text = ["Global default", "-", "FFmpeg", "VLC", "HDHR Remux", "HDHR Safe"];
            var values = ["default", "-", "ffmpeg", "vlc", "hdhr-remux", "hdhr-safe"];
...
function changeChannelLogo(epgMapId) {
    ...
    const logoInput = document.getElementById('channel-icon');
    if (logoInput) {
